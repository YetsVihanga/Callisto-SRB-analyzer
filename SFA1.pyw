...
root = tk.Tk()
root.title('Solar Radio Burst Analizer (Type II and Type III)')
...
instructions3 = tk.Label(root, text="Maximum Intensity frquency plot -->", font=("Raleway",10), justify=LEFT)
instructions3.grid(columnspan=3, column=0, row=17)

instructions4 = tk.Label(root, text="Mhz s^(-1)", font=("Raleway",12), justify=LEFT)
